...
/*
 * Destructs the grid by deleting each node individually,
 * the node destructors will delete their own set of edges
 */
...
/*
Since each node has an x/y coordinate, if you pass a Node* into replace node,
it will take the node at the passed in
