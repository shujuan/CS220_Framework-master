...
void Utilities::GRNode::displayNode( ) {
	std::cout << "(" << get_x() << " M " << getLeeMark() <<
								" Id " << getNetID() << " " << get_y() << ") \n " ;
}

void Utilities::GRNode::displayPriority( ) {
	std::cout << "(" << get_x() << " P " << getPriority() <<
								" Id " << getNetID() << " " << get_y() << ") \n " ;
}
...
bool Utilities::GRNode::getUpdatedCell( )  {
	return this->updateCell ;
}

void Utilities::GRNode::setUpdatedCell( bool c )  {
	this->updateCell = c;
}
